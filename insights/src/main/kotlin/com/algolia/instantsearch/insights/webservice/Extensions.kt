...
internal fun computeUserAgent(): String {
    ...
    val insightsVersion = LibraryVersion(name = "insights-android", version = BuildConfig.INSIGHTS_VERSION)
    val androidVersion = LibraryVersion(name = "Android", version = "${Build.VERSION.SDK_INT}.0.0")
